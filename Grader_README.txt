...
look in the .oca.ml.d directory to see an example of user defined syntax highlighting.
If you want to provide your own ocaml code, make sure to put it in that directory.
